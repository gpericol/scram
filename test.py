...
# authentication
data = client.authentication_pairing(username, client_values['client_key'], client_values['server_key'])
data = server.authentication_pairing(data['username'], data['client_nonce'])
data = client.authentication_client_proof_generation(data['nonce'], data['salt'], data['ic'])
data = server.authentication_proof(data['client_proof'], data['nonce'])
data = client.server_authentication(data['server_signature'])
print data
